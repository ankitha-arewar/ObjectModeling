...
public class ContestService implements IContestService {
    ...
    private List<Question> pickQuestionsList(final List<Question> questions,final Integer numQuestion){
      List<Question> quesList = new ArrayList<>(questions);
      Collections.shuffle(quesList);
      return quesList.stream().limit(numQuestion).collect(Collectors.toList());
    }
    ...
    @Override
    public Object create(String contestName, String lvl, String creator, Integer numOfQues) {
