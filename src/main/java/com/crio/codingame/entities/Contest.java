...
public class Contest extends BaseEntity{
    ...
    private void validateQuestionList(List<Question> qList, Level contestLevel) throws InvalidContestException {
        for (Question ques : qList) {
            if (!ques.getLevel().equals(contestLevel)) {
                throw new InvalidContestException("InvalidContestException");
            }
        }
        // for (Question question : qList) {
        //     if (!question.getLevel().equals(contestLevel)) {
        //         throw new InvalidContestException("All questions in the contest must be of the same level as the contest.");
        //     }
        // }
    }
